...
const galaxies = [
    ...
    },
    {
        ...
        starImage: 'images/cartwheel.jpg',
...
const galaxyBackgrounds = {
    ...
    3: "url('wood.png'), linear-gradient(to bottom, #1a1a1a, #4c1d1d, #b56c6c)",
    4: "url('old-map.png'), linear-gradient(to bottom, #2a2a2a, #6c1616, #d84d4d)",
    5: "url('old-map.png'), linear-gradient(to bottom, #1a1a1a, #6f1d1d, #b95e5e)",
    6: "url('snow.png'), linear-gradient(to bottom, #0a0a0a, #1f1f1f, #404040)",
    7: "url('wood.png'), linear-gradient(to bottom, #2e2e2e, #4e4e4e, #6c6c6c)",
    ...
    10: "url('paper.png'), linear-gradient(to bottom, #1d1d1d, #3a3a3a, #595959)",
    11: "url('asfalt-light.png'), linear-gradient(to bottom, #2a2a2a, #3c3c3c, #4e4e4e)",
    12: "url('asfalt-light.png'), linear-gradient(to bottom, #1f1f1f, #3f3f3f, #5f5f5f)",
    13: "url('paper.png'), linear-gradient(to bottom, #262626, #484848, #6a6a6a)",
    14: "url('dark-fish-skin.png'), linear-gradient(to bottom, #1b1b1b, #353535, #4f4f4f)",
    15: "url('dark-matter.png'), linear-gradient(to bottom, #2d2d2d, #4d4d4d, #6d6d6d)",
    16: "url('dark-wall.png'), linear-gradient(to bottom, #1c1c1c, #3c3c3c, #5c5c5c)",
    17: "url('dimension.png'), linear-gradient(to bottom, #292929, #4b4b4b, #6d6d6d)",
    18: "url('dimension.png'), linear-gradient(to bottom, #191919, #383838, #575757)",
    19: "url('dimension.png'), linear-gradient(to bottom, #2e2e2e, #4e4e4e, #6e6e6e)",
    20: "url('gplay.png'), linear-gradient(to bottom, #1a1a1a, #3a3a3a, #5a5a5a)"
};
